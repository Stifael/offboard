...
class visualize():
    def __init__(self):
        ...
        self.pub_vel = rospy.Publisher('vehicle/vel', Marker, queue_size=10)
        self.pub_pose_x = rospy.Publisher('vehicle/pose_x', Marker, queue_size=10)
        self.pub_acc = rospy.Publisher('vehicle/acc', Marker, queue_size=10)
        self.pub_target = rospy.Publisher('vehicle/target', Marker, queue_size=10)
        self.pub_path = rospy.Publisher('path/target', Marker, queue_size=10 )
        self.pub_sp = rospy.Publisher('path/setpoints', Marker, queue_size=10)
